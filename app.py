...
@app.route('/dean/violations/pdf', methods=['GET'])
    ...
    try:
        ...
        if not violations:
            ...
            for v in violations:
                ...
                program = str(v.get('program', '')).strip()
                if program:
                ...
                table_data.append([
                    ...
                    Paragraph(program[:35] if program else 'N/A', normal_style),
...
@app.route('/dean/college', methods=['GET'])
def dean_college():
...
@app.route('/dean/students', methods=['GET'])
def dean_students():
...
@app.route('/dean/students/<student_id>', methods=['GET'])
...
@app.route('/dean/students/<student_id>', methods=['PUT'])
...
@app.route('/dean/students/<student_id>', methods=['DELETE'])
...
@app.route('/dean/students/add', methods=['POST'])
...
@app.route('/osas/violations/pdf', methods=['GET'])
        ...
        if not violations:
            ...
            for v in violations:
                ...
                table_data.append([
                    ...
                    Paragraph(program[:30] if program else 'N/A', normal_style),
                    Paragraph(gender[:8], normal_style),
