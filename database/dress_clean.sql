...
CREATE TABLE `admins` (
  ...
  `college` enum('College of Sciences','College of Engineering','College of Architecture and Design','College of Arts and Humanities','College of Business and Accountancy','College of Criminal Justice Education','College of Hospitality and Tourism Management','College of Nursing and Health Sciences','College of Teacher Education') DEFAULT NULL,
