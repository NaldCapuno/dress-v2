...
-- Insert dummy violations (with timestamps, some older than 3 days)
INSERT INTO `violations` (`student_id`, `violation_type`, `timestamp`, `image_proof`, `status`) VALUES
  ('2020-1-0001', 'missing polo_shirt', '2025-10-25 08:00:00', NULL, 'pending'),
  ('2021-2-0002', 'missing pants', '2025-10-30 09:15:00', NULL, 'forwarded_dean'),
  ('2022-3-0003', 'missing shoes', '2025-10-20 10:00:00', NULL, 'pending'),
  ('2023-4-0004', 'missing blouse', '2025-09-28 14:15:00', NULL, 'resolved'),
  ('2020-1-0005', 'missing skirt', '2025-10-22 11:30:00', NULL, 'pending'),
  ('2021-2-0006', 'missing doll_shoes', '2025-09-29 08:20:00', NULL, 'forwarded_guidance'),
  ('2022-3-0007', 'missing polo_shirt', '2025-10-26 08:45:00', NULL, 'pending'),
  ('2023-4-0008', 'missing pants', '2025-10-24 07:50:00', NULL, 'pending'),
  ('2021-1-0009', 'missing shoes', '2025-10-21 09:00:00', NULL, 'forwarded_dean'),
  ('2022-2-0010', 'missing blouse', '2025-10-23 10:10:00', NULL, 'pending'),
  ('2023-3-0011', 'missing skirt', '2025-09-30 11:45:00', NULL, 'resolved'),
  ('2024-4-0012', 'missing doll_shoes', '2025-10-25 12:00:00', NULL, 'pending'),
  ('2024-1-0013', 'missing polo_shirt', '2025-10-18 09:00:00', NULL, 'pending'),
  ('2020-2-0014', 'missing pants', '2025-09-27 08:40:00', NULL, 'forwarded_guidance'),
  ('2024-3-0015', 'missing shoes', '2025-10-28 15:30:00', NULL, 'pending'),
  ('2021-4-0016', 'missing blouse', '2025-10-29 07:55:00', NULL, 'pending'),
  ('2020-3-0017', 'missing skirt', '2025-10-19 16:10:00', NULL, 'pending'),
  ('2022-4-0018', 'missing doll_shoes', '2025-10-21 08:20:00', NULL, 'pending'),
